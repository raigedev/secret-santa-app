...
- 2026-04-28T00:55:00+08:00 [CODE] `/secret-santa` Lazada CTA uses a shared light evergreen shopping pill with a dark icon capsule instead of the previous heavy red gradient; authenticated Playwright checks CTA shape and arrow treatment. 2026-04-28T01:27:35+08:00 [CODE] Lazada match loading now skips already in-flight request keys to prevent `Maximum update depth exceeded`.
