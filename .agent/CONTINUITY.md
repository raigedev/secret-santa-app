...
- 2026-04-25T21:41:00+08:00 [CODE] `/secret-santa` shopping-option chips no longer show a visible `Selected` mini-pill; the active option is indicated by green tint, border, shadow, and marker while keeping accessible selected state.
