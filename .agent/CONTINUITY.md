...
- 2026-04-27T22:48:37+08:00 [TOOL] Added official skills `playwright`, `playwright-interactive`, `security-best-practices`, `security-ownership-map`, and `sentry`; added project docs for architecture/testing/deploy/known issues/CSS, plus `audit:unused` and `analyze:bundle` scripts.
