...
import { TipJarNavLink } from "@/app/components/TipJarSupport";
    ...
    <>
      <style>{`
        *{margin:0;padding:0;box-sizing:border-box;}
        :root{--red:#c0392b;--red-light:#e74c3c;--red-dark:#922b21;--green:#1a6b2a;--green-light:#22c55e;--gold:#f59e0b;--gold-light:#fbbf24;--cream:#fdfbf7;--navy:#0f1f3d;--landing-shell-width:min(calc(100% - 48px),1360px);}
        html{scroll-behavior:smooth;}
        body{font-family:var(--font-landing-body),sans-serif;color:#1f2937;overflow-x:hidden;background:var(--cream);}
        ...
        .nav-inner{width:var(--landing-shell-width);margin:0 auto;display:flex;align-items:center;justify-content:space-between;}
        ...
        .hero{min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(170deg,#fdfbf7 0%,#fef3e2 25%,#fce7d0 50%,#f9d4b8 75%,#f0c5a0 100%);position:relative;overflow:hidden;padding:120px 0 80px;}
        ...
        .hero-inner{width:var(--landing-shell-width);margin:0 auto;display:flex;align-items:center;gap:60px;position:relative;z-index:1;}
        .hero-text{flex:1;}
        ...
        .hc1-title{font-family:var(--font-landing-display),sans-serif;font-size:20px;font-weight:700;margin-bottom:8px;}
        ...
        .hc2-name{font-family:var(--font-landing-display),sans-serif;font-size:22px;font-weight:700;margin-top:4px;}
        ...
        .section-title{font-family:var(--font-landing-serif),serif;font-size:40px;font-weight:900;text-align:center;color:#1a1a1a;margin-bottom:12px;}
        ...
        .step-num{position:absolute;top:-16px;left:50%;transform:translateX(-50%);width:36px;height:36px;border-radius:50%;font-family:var(--font-landing-display),sans-serif;font-size:16px;font-weight:700;display:flex;align-items:center;justify-content:center;color:#fff;}
        ...
        .step-title{font-family:var(--font-landing-display),sans-serif;font-size:20px;font-weight:700;color:#1a1a1a;margin-bottom:8px;}
        ...
        .feature-title{font-family:var(--font-landing-display),sans-serif;font-size:17px;font-weight:700;color:#1a1a1a;margin-bottom:6px;}
        ...
        .cta-title{font-family:var(--font-landing-serif),serif;font-size:42px;font-weight:900;color:#fff;margin-bottom:12px;text-shadow:0 2px 8px rgba(0,0,0,.15);}
        ...
        .app-title{font-family:var(--font-landing-serif),serif;font-size:30px;font-weight:900;color:#fff;margin-bottom:8px;}
        ...
        @media(max-width:1024px){
          :root{--landing-shell-width:calc(100% - 40px);}
          .nav-inner{gap:20px;}
          .nav-links{gap:18px;}
          .hero{padding:110px 0 72px;}
          .hero-inner{gap:36px;align-items:flex-start;}
          ...
          .hc3{width:248px;}
          .steps{gap:20px;}
          .features-grid,.testimonials-grid{gap:16px;}
          .section-title{font-size:36px;}
        }

        @media(max-width:768px){
          :root{--landing-shell-width:calc(100% - 32px);}
          nav{padding:10px 0;}
          .nav-inner{gap:12px;}
          .nav-links{gap:8px;}
          ...
          .hero-buttons{justify-content:center;width:100%;flex-direction:column;align-items:stretch;}
          .btn-primary,.btn-secondary,.btn-cta{justify-content:center;width:100%;}
          .hero-stats{justify-content:center;gap:18px;flex-wrap:wrap;}
        ...
        @media(max-width:560px){
          ...
          .feature-card,.testimonial,.step{padding:22px 18px;}
          .how-section,.features-section,.testimonials-section,.cta-section,.app-section,footer{padding-left:16px;padding-right:16px;}
