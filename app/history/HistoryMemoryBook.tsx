        ...
        <div className="relative">
          ...
          <div className="mt-7 grid gap-6 xl:grid-cols-[minmax(0,1fr)_21rem]">
            <section className="min-w-0">
              <div className="grid grid-cols-2 overflow-hidden rounded-t-3xl bg-[#f3f4f2] ring-1 ring-[#48664e]/12 sm:grid-cols-4">
                {["Recap", "Past Wishlist", "Result Card", "Notes"].map((tab) => {
                  const active = tab === "Past Wishlist";
                  return (
                    <button
                      key={tab}
                      type="button"
              ...
              <div className="rounded-b-3xl bg-white/94 p-4 ring-1 ring-[#48664e]/12 sm:p-6">
