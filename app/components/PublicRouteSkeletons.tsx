      ...
      <div className="relative mx-auto flex min-h-[calc(100vh-3rem)] max-w-6xl items-center">
        <div className="grid w-full gap-4 rounded-[2.25rem] bg-white/72 p-3 shadow-[0_32px_90px_rgba(46,52,50,0.08)] backdrop-blur-xl lg:grid-cols-[1.02fr_0.98fr] lg:p-4">
          <section className="rounded-[1.9rem] bg-[#ecefec] px-6 py-8 sm:px-8 sm:py-10 lg:px-10 lg:py-12">
            ...
            <SkeletonBlock className="mt-8 h-44 w-full rounded-[2rem] bg-white/82" />
          </section>
          <section className="rounded-[1.9rem] bg-white px-5 py-6 sm:px-8 sm:py-8 lg:px-10 lg:py-10">
            ...
            <div className="mt-8 space-y-5">
              <SkeletonBlock className="h-[74px] w-full rounded-[1.5rem]" />
              <SkeletonBlock className="h-[74px] w-full rounded-[1.5rem]" />
    ...
    <main className="min-h-screen bg-[#f7f7f2] px-4 py-6 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <section className="grid min-h-[calc(100vh-7rem)] items-center gap-8 py-10 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <SkeletonBlock className="h-[420px] w-full rounded-[2rem] bg-white" />
        </section>
      </div>
    </main>
  );
  ...
  return (
    <main className="min-h-screen bg-[linear-gradient(180deg,#eef4fb,#f8fbff,#fff7ef)] px-4 py-8">
      <div className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-3xl items-center justify-center">
        <section className="w-full rounded-[2rem] bg-white/88 p-6 shadow-[0_28px_80px_rgba(46,52,50,0.1)] sm:p-8">
          <SkeletonBlock className="h-10 w-40 rounded-full" />
          <SkeletonBlock className="mt-7 h-12 w-10/12 rounded-2xl" />
          <SkeletonBlock className="mt-3 h-6 w-8/12 rounded-full" />
          <SkeletonBlock className="mt-8 h-32 w-full rounded-[1.5rem]" />
...
export function ResetPasswordRouteSkeleton() {
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#f9faf8] px-4 py-8">
      <section className="w-full max-w-md rounded-[2rem] bg-white p-6 shadow-[0_28px_80px_rgba(46,52,50,0.1)]">
        <SkeletonBlock className="h-9 w-44 rounded-2xl" />
        <SkeletonBlock className="mt-3 h-5 w-full rounded-full" />
        <SkeletonBlock className="mt-8 h-[74px] w-full rounded-[1.5rem]" />
