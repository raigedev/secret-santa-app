    ...
    <article className="holiday-panel-strong relative overflow-hidden rounded-[30px] p-5">
      ...
      <div className="relative z-10 mt-5 flex flex-wrap gap-3">
        <button
          ...
          className="gift-button gift-button-primary gift-button-compact min-w-35 text-sm"
        >
          {status === "loading"
            ? "Processing..."
            : requiresAnonymousNickname
        ...
        <button
          ...
          disabled={status === "loading"}
          className="gift-button gift-button-secondary gift-button-compact min-w-35 text-sm"
        >
          Decline invite
        </button>
      </div>
