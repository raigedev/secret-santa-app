...
import { normalizeTrustedLazadaImageUrl } from "@/lib/affiliate/lazada-url";
...
const SHOPPING_CARD_BACKGROUND =
  "repeating-linear-gradient(135deg,rgba(72,102,78,.08) 0 1px,transparent 1px 30px), repeating-linear-gradient(45deg,rgba(252,206,114,.12) 0 1px,transparent 1px 44px), linear-gradient(180deg,#fffefa 0%,#fbfcf7 54%,#eff7f0 100%)";
const SHOPPING_CARD_CONTENT_BACKGROUND =
  "linear-gradient(180deg,rgba(255,254,250,.96),rgba(248,251,247,.96))";
const SHOPPING_MEDIA_WELL_BACKGROUND =
  "radial-gradient(circle at 22% 24%,rgba(252,206,114,.18),transparent 11rem), repeating-linear-gradient(135deg,rgba(72,102,78,.08) 0 1px,transparent 1px 32px), linear-gradient(180deg,#fffefa 0%,#edf5ef 100%)";
const SHOPPING_CARD_BORDER = "2px solid rgba(72,102,78,.42)";
const SHOPPING_CARD_SHADOW =
  "0 24px 54px rgba(46,52,50,.1), 0 0 0 5px rgba(255,255,255,.58), inset 0 1px 0 rgba(255,255,255,.94)";
...
const SHOPPING_PANEL_BACKGROUND_IMAGE =
  "linear-gradient(135deg,#eef6ee 0%,#ffffff 48%,#fff7df 100%), repeating-linear-gradient(135deg,#d7e6da 0 1px,transparent 1px 34px), repeating-linear-gradient(45deg,#ffe7aa 0 1px,transparent 1px 54px)";
...
const SHOPPING_SHELL_BACKGROUND =
  "linear-gradient(180deg,rgba(255,254,250,.98),rgba(249,251,247,.96))";
const SHOPPING_SHELL_BORDER = "1px solid rgba(72,102,78,.2)";
const SHOPPING_SHELL_SHADOW =
  "0 22px 54px rgba(46,52,50,.08), inset 0 1px 0 rgba(255,255,255,.94)";
...
function ShoppingBagMark({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg
      aria-hidden="true"
      className={className}
    ...
    >
      <path
        d="M6.6 8.3h10.8l1 11.1H5.6L6.6 8.3Z"
        stroke="currentColor"
        strokeLinejoin="round"
        strokeWidth="1.8"
      />
      <path
        d="M9.1 8.2c0-2.7 1.2-4.2 2.9-4.2s2.9 1.5 2.9 4.2"
        stroke="currentColor"
        strokeLinecap="round"
        strokeWidth="1.8"
      />
      <path d="M9.2 12.1h5.6v4.8H9.2v-4.8Z" stroke="currentColor" strokeWidth="1.8" />
      <path d="M12 12.1v4.8M9.2 14.5h5.6" stroke="currentColor" strokeWidth="1.8" />
    </svg>
  );
}

function StorefrontMark({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg
      aria-hidden="true"
      className={className}
    ...
    >
      <path
        d="M5.3 10.4h13.4v8.2H5.3v-8.2Z"
        stroke="currentColor"
        strokeLinejoin="round"
        strokeWidth="1.8"
      />
      <path
        d="M4.5 6.2h15l1 4.2H3.5l1-4.2Z"
        stroke="currentColor"
        strokeLinejoin="round"
        strokeWidth="1.8"
      />
      <path d="M8.1 18.6v-5.1h3.2v5.1M13.8 14h2.8" stroke="currentColor" strokeWidth="1.8" />
    </svg>
  );
}
  ...
  if (name === "history") {
    return (
      <svg {...commonProps}>
        ...
        />
        <path
          d="M5.9 11.3a6.5 6.5 0 1 0 2-4.8L5.2 9"
          stroke="currentColor"
          strokeLinecap="round"
          strokeLinejoin="round"
          strokeWidth="1.8"
        />
        <path d="M12 8.2v4.4l2.9 1.7" stroke="currentColor" strokeLinecap="round" strokeWidth="1.8" />
      </svg>
    );
  }
  ...
  if (name === "settings") {
    return (
      <svg {...commonProps}>
        ...
        <path d="M12 3.6v2M12 18.4v2M4.6 12h2M17.4 12h2M6.8 6.8l1.4 1.4M15.8 15.8l1.4 1.4M17.2 6.8l-1.4 1.4M8.2 15.8l-1.4 1.4" stroke="currentColor" strokeLinecap="round" strokeWidth="1.8" />
      </svg>
    );
  }
...
function ShoppingIdeasHeroMark({ className = "h-12 w-12" }: { className?: string }) {
  return (
    <svg aria-hidden="true" className={className} viewBox="0 0 72 72" fill="none">
      <path
        d="M18 24.5h36l3.2 33H14.8l3.2-33Z"
        fill="#fffefa"
        stroke="#48664e"
        strokeLinejoin="round"
        strokeWidth="3"
      />
      <path
        d="M27 24c0-8 3.7-12.2 9-12.2S45 16 45 24"
        stroke="#48664e"
        strokeLinecap="round"
        strokeWidth="3"
      />
      <path d="M26 34h20v17H26V34Z" fill="#a43c3f" />
      <path d="M36 34v17M26 42.5h20" stroke="#fcce72" strokeWidth="3" />
      <path
        d="M30 33c-5.4-7.5 4.2-12.8 6-2 2.7-10.8 12.3-5.5 6 2"
        stroke="#fcce72"
        strokeLinecap="round"
        strokeWidth="3"
      />
      <circle cx="55" cy="18" r="2.5" fill="#a43c3f" />
      <circle cx="15" cy="52" r="2.4" fill="#fcce72" />
      <path d="M58 31h6M61 28v6" stroke="#fcce72" strokeLinecap="round" strokeWidth="2.4" />
    </svg>
  );
}
...
function UserGroupMark({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg
      aria-hidden="true"
      className={className}
    ...
    >
      <path
        d="M8.3 11.4a3.2 3.2 0 1 0 0-6.4 3.2 3.2 0 0 0 0 6.4ZM15.9 11.4a3.2 3.2 0 1 0 0-6.4 3.2 3.2 0 0 0 0 6.4Z"
        stroke="currentColor"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="1.8"
      />
      <path
        d="M3.8 19.4c.9-3.1 2.6-4.7 5-4.7 1.4 0 2.4.4 3.2 1.2.8-.8 1.9-1.2 3.2-1.2 2.5 0 4.2 1.6 5 4.7"
        stroke="currentColor"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="1.8"
...
function ChevronDownMark({ className = "h-4 w-4" }: { className?: string }) {
  return (
    <svg
      aria-hidden="true"
      className={className}
...
function ChevronRightMark({ className = "h-4 w-4" }: { className?: string }) {
  return (
    <svg
      aria-hidden="true"
      className={className}
...
function CheckCircleMark({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg
      ...
      fill="none"
    >
      <circle cx="10" cy="10" r="8.1" fill="currentColor" opacity=".18" />
      <path
        d="m6.5 10.1 2.2 2.3 4.9-5"
        stroke="currentColor"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="2"
...
function GiftBoxIllustration({ className = "h-16 w-16" }: { className?: string }) {
  return (
    <svg
      ...
      fill="none"
    >
      <ellipse cx="49" cy="76" rx="27" ry="8" fill="rgba(46,52,50,.08)" />
      <rect x="23" y="35" width="46" height="38" rx="7" fill="#48664e" />
      <rect x="20" y="28" width="52" height="16" rx="6" fill="#fcce72" />
      <path d="M45 28h9v45h-9V28Z" fill="#fff8de" opacity=".9" />
      <path d="M20 39h52" stroke="#2f4d39" strokeWidth="2" opacity=".26" />
      <path
        d="M47 28c-7.6-13-22-7.3-17.1 2.2 2.4 4.5 10.4 3.6 17.1-2.2Zm3.5 0c8.6-12.4 21.9-5.8 16.3 3.2-2.8 4.4-10.4 2.9-16.3-3.2Z"
        fill="#a43c3f"
      />
      <path
        d="M22 69c10.3-5.3 25.7-6.1 48-1.9"
        stroke="#fffefa"
        strokeLinecap="round"
        strokeWidth="2"
        opacity=".32"
      />
      <circle cx="74" cy="26" r="2.6" fill="#fcce72" />
      <circle cx="17" cy="52" r="2" fill="#a43c3f" opacity=".7" />
      <path
        d="M74 49c3 1 4.8 2.8 5.6 5.7M78.3 47.7c-1.1 3.4-3.1 5.2-6.2 5.7"
        stroke="#fcce72"
        strokeLinecap="round"
        strokeWidth="1.8"
      />
...
function ProductFallbackIllustration({
  ...
  const kind = /earbud|earphone|headphone|neckband/.test(normalizedTitle)
    ? "audio"
    : /tablet|stand|holder|phone/.test(normalizedTitle)
      ? "stand"
      : /hoodie|shirt|tee|top/.test(normalizedTitle)
        ? "shirt"
        : /pant|trouser|legging|bottom/.test(normalizedTitle)
          ? "pants"
          : "gift";
  ...
  return (
    <svg
      ...
      fill="none"
    >
      <rect width="320" height="220" rx="30" fill="#fffdf7" />
      <path
        d="M24 174c57-36 118-43 183-24 29 8 58 9 89-7"
        stroke="#e4eadf"
        strokeLinecap="round"
        strokeWidth="16"
      />
      <path
        d="M32 50c45-22 95-26 151-12 41 11 75 7 104-12"
        stroke="#fff0c8"
        strokeLinecap="round"
        strokeWidth="18"
      />
      {kind === "audio" && (
        <g transform="translate(70 46)">
          <ellipse cx="50" cy="38" rx="38" ry="22" fill="#f4dfbd" />
          <ellipse cx="135" cy="28" rx="33" ry="20" fill="#f1d8b0" />
          <path
            d="M60 90c42 34 91 30 122-8"
            stroke="#c9b18b"
            strokeLinecap="round"
            strokeWidth="12"
          />
          <path
            d="M78 54c-16 22-22 41-17 58M151 46c12 24 13 45 3 63"
            stroke="#d6bd95"
            strokeLinecap="round"
            strokeWidth="8"
          />
          <rect x="42" y="100" width="26" height="38" rx="12" fill="#f8efe2" stroke="#bda47c" strokeWidth="4" />
          <rect x="145" y="96" width="26" height="40" rx="12" fill="#f8efe2" stroke="#bda47c" strokeWidth="4" />
        </g>
      )}
      {kind === "stand" && (
        <g transform="translate(70 34)">
          <rect x="42" y="10" width="134" height="88" rx="12" fill="#34423b" />
          <rect x="52" y="20" width="114" height="68" rx="8" fill="#6f7e76" />
          <path d="M110 98v46" stroke="#34423b" strokeLinecap="round" strokeWidth="12" />
          <path d="M72 148h76" stroke="#34423b" strokeLinecap="round" strokeWidth="14" />
          <path d="M92 104 62 148M128 104l30 44" stroke="#6b746f" strokeLinecap="round" strokeWidth="7" />
          <circle cx="110" cy="98" r="9" fill="#fcce72" />
        </g>
      )}
      {kind === "shirt" && (
        <g transform="translate(78 34)">
          <path
            d="M70 12h58l34 28-26 34-15-10v94H76V64L61 74 35 40 70 12Z"
            fill="#e8ece7"
            stroke="#9aa89e"
            strokeLinejoin="round"
            strokeWidth="5"
          />
          <path d="M88 15c7 14 23 14 30 0" stroke="#9aa89e" strokeLinecap="round" strokeWidth="5" />
          <path d="M78 88h42M78 110h56" stroke="#c8d0c9" strokeLinecap="round" strokeWidth="5" />
        </g>
      )}
      {kind === "pants" && (
        <g transform="translate(82 34)">
          <path
            d="M66 12h76l10 154h-45L96 78 82 166H37L66 12Z"
            fill="#e7f0e9"
            stroke="#8fa596"
            strokeLinejoin="round"
            strokeWidth="5"
          />
          <path d="M66 38h77M103 42l-5 124" stroke="#8fa596" strokeLinecap="round" strokeWidth="5" />
          <path d="M75 22c10 7 21 7 32 0" stroke="#fcce72" strokeLinecap="round" strokeWidth="5" />
        </g>
      )}
      {kind === "gift" && <GiftBoxIllustration className="mx-auto h-full w-44" />}
    </svg>
  );
}

function HolidayCornerSprig({ className = "h-24 w-24" }: { className?: string }) {
  return (
    <svg
      aria-hidden="true"
      className={className}
    ...
    >
      <path
        d="M101 9C76 32.7 52 52.5 17 75"
        stroke="#48664e"
        strokeLinecap="round"
        strokeWidth="4"
      />
      {[18, 30, 42, 54, 66, 78, 90].map((point, index) => (
        <g key={point}>
          <path
            d={`M${point} ${79 - index * 10}c14-1 23-5 31-13`}
            stroke="#48664e"
            strokeLinecap="round"
            strokeWidth="3"
            opacity=".88"
          />
          <path
            d={`M${point + 4} ${82 - index * 10}c2 11 8 18 18 23`}
            stroke="#48664e"
            strokeLinecap="round"
            strokeWidth="3"
            opacity=".72"
      ...
      <circle cx="32" cy="67" r="3" fill="#a43c3f" />
      <circle cx="58" cy="43" r="3" fill="#fcce72" />
      <circle cx="84" cy="22" r="2.5" fill="#a43c3f" />
    </svg>
  );
}

function HelperActionIcon({
  tone,
  className = "h-5 w-5",
}: {
  tone: "shield" | "coin" | "search" | "note";
  className?: string;
}) {
  const commonProps = {
    className,
  ...
  if (tone === "coin") {
    return (
      <svg {...commonProps}>
        ...
        <path
          d="M5.5 6.5v7.8c0 1.7 2.9 3 6.5 3s6.5-1.3 6.5-3V6.5M5.5 10.4c0 1.7 2.9 3 6.5 3s6.5-1.3 6.5-3"
          stroke="currentColor"
          strokeLinecap="round"
          strokeLinejoin="round"
          strokeWidth="1.8"
  ...
  if (tone === "search") {
    return (
      <svg {...commonProps}>
        <circle cx="10.4" cy="10.4" r="5.6" stroke="currentColor" strokeWidth="1.8" />
        <path d="m15 15 4.4 4.4" stroke="currentColor" strokeLinecap="round" strokeWidth="1.8" />
      </svg>
    );
  }
  ...
  if (tone === "note") {
    return (
      <svg {...commonProps}>
        <path
          d="M5.4 5.2h13.2v10.7H9.2L5.4 19V5.2Z"
          stroke="currentColor"
          strokeLinejoin="round"
          strokeWidth="1.8"
        />
        <path d="M8.4 8.7h7.2M8.4 12h5.1" stroke="currentColor" strokeLinecap="round" strokeWidth="1.8" />
      </svg>
    );
  }
  ...
  return (
    <svg {...commonProps}>
      <path
        d="M12 3.8 18.5 6v5.7c0 4.2-2.5 7.1-6.5 8.5-4-1.4-6.5-4.3-6.5-8.5V6L12 3.8Z"
        stroke="currentColor"
        strokeLinejoin="round"
        strokeWidth="1.8"
      />
      <path
        d="m8.9 11.8 2 2 4.2-4.5"
        stroke="currentColor"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="1.8"
...
function ShoppingIdeasSidebar({
  ...
  return (
    ...
    >
      ...
      <nav data-app-sidebar-nav="" aria-label="Secret Santa shopping navigation" className="mt-9 flex flex-col gap-2">
        {navItems.map((item) => (
          <a
            ...
            style={{
              ...
              boxShadow: item.active
                ? "inset 0 0 0 1px rgba(72,102,78,.08)"
                : "none",
            }}
          >
...
function ShoppingIdeasHeader({
  ...
  const subtitle =
    mode === "giftee"
      ? "Recipient details, wishlist clues, gift day, and budget."
      : mode === "tracking"
        ? "Track what you have planned, bought, wrapped, and received."
        : "Shop gift ideas from wishlists, budgets, and affiliate links.";
  ...
  return (
    <header
      ...
      className="sticky top-0 z-20 hidden h-21 items-center justify-between border-b px-7 xl:flex"
      style={{
        background:
    ...
    >
      ...
      <div className="flex shrink-0 items-center gap-3">
        ...
        <a
          href="/profile"
          className="flex items-center gap-3 rounded-full py-1.5 pl-2 pr-4 transition hover:-translate-y-0.5"
          style={{
            background: "rgba(255,255,255,.78)",
        ...
        >
          ...
          <ChevronDownMark className="hidden h-4 w-4 lg:block" />
        </a>
      </div>
    </header>
  );
...
function ShoppingRegionHelperControl({
  ...
  const helperText =
    ...
    "Shopping links use this region.";
    ...
    >
      <span className="flex items-center justify-between gap-3">
        ...
        <select
          ...
          className="min-h-10 min-w-33 rounded-full bg-transparent px-3 py-1.5 text-right text-[12px] font-extrabold outline-none"
      ...
      <span
        className="mt-1 block text-[10px] font-semibold leading-relaxed"
...
function SantaHelperSidecar({
  ...
  return (
    ...
    >
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -right-8 top-40 h-44 w-44 rounded-full"
        style={{
          background:
            "radial-gradient(circle,rgba(252,206,114,.22),rgba(252,206,114,0) 68%)",
        }}
      />
      <div className="flex items-start justify-between gap-3">
        <div>
          <div
            className="flex items-center gap-2 text-[20px] font-black leading-tight"
            style={{ color: HOLIDAY_GREEN, fontFamily: "'Fredoka', 'Nunito', sans-serif" }}
          >
            <SparkleMark className="h-4 w-4" />
            <span>Santa Helper</span>
            <SparkleMark className="h-4 w-4" />
          </div>
        ...
        <button
          ...
          className="flex h-9 w-9 items-center justify-center rounded-full text-[14px] font-black transition hover:-translate-y-0.5 focus-visible:outline-2 focus-visible:outline-offset-2"
          style={{
      ...
      <div className="mt-4 space-y-2.5">
        {helperActions.map(([label, helper, tone]) => (
          <button
            ...
            type="button"
            onClick={jumpToTopPicks}
            className="flex w-full items-center justify-between gap-3 rounded-[20px] px-3 py-3 text-left transition hover:-translate-y-0.5 focus-visible:outline-2 focus-visible:outline-offset-2"
            style={{
              background: "rgba(255,255,255,.72)",
              border: "1px solid rgba(72,102,78,.12)",
              color: PAGE_TEXT_COLOR,
...
function MyGifteeWorkspace({ assignments }: { assignments: RecipientData[] }) {
  const groupCount = new Set(assignments.map((assignment) => assignment.group_id)).size;
  const wishlistIdeaCount = assignments.reduce(
    (total, assignment) => total + assignment.receiver_wishlist.length,
    0
  );
  const nextGiftDate =
    assignments
      .map((assignment) => assignment.group_event_date)
    ...
    >
      <div className="grid gap-5 lg:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)]">
        <div>
          ...
          >
            People you are gifting
          </h2>
          <p className="mt-3 max-w-md text-[13px] leading-relaxed" style={{ color: TEXT_MUTED }}>
            Keep each match private. Use this briefing to check gift day, budget,
            wishlist clues, and your progress before you shop.
          </p>
          <div className="mt-5 grid gap-3 sm:grid-cols-3 lg:grid-cols-1">
            {[
              ...
              >
                <p className="text-[10px] font-black uppercase tracking-[0.14em]" style={{ color: TEXT_MUTED }}>
                  {label}
                </p>
                <p className="mt-1 text-[18px] font-black" style={{ color: PAGE_TEXT_COLOR }}>
                  {value}
                </p>
                <p className="mt-0.5 text-[11px] font-semibold" style={{ color: TEXT_SOFT }}>
                  {helper}
                </p>
              </div>
            ))}
          ...
          {assignments.map((assignment) => {
            const budgetLabel =
              assignment.group_budget !== null
                ...
                : "Set in group";
            const wishlistPreview = assignment.receiver_wishlist
              .slice(0, 4);
            const primaryWishlistNote =
              wishlistPreview.find((item) => item.item_note.trim().length > 0)?.item_note ||
              "";
            const progressLabel = getGiftPrepLabel(assignment.gift_prep_status);
              ...
              >
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  <div className="min-w-0">
                    ...
                    <h3 className="mt-1 text-[20px] font-black leading-tight text-slate-950">
                  ...
                  <a
                    href={`/secret-santa#matches-${assignment.group_id}`}
                    className="inline-flex min-h-11 shrink-0 items-center justify-center rounded-full px-5 text-[12px] font-extrabold transition hover:-translate-y-0.5"
                    style={{
                ...
                <div
                  className="mt-4 rounded-[18px] p-3 text-[12px] leading-relaxed"
                  style={{
                    background: "rgba(72,102,78,.07)",
                    color: PAGE_TEXT_COLOR,
                  }}
                >
                  <div className="flex flex-wrap gap-2">
                    {wishlistPreview.length > 0 ? (
                      wishlistPreview.map((item) => (
                        <span
                          key={item.id}
                          className="rounded-full bg-white/82 px-3 py-1 text-[11px] font-extrabold"
                          style={{ color: PAGE_TEXT_COLOR }}
                        >
                          {item.item_name}
                        </span>
                      ...
                      <span className="font-semibold" style={{ color: TEXT_MUTED }}>
                        No wishlist ideas yet.
                      </span>
                    )}
                  </div>
                  {primaryWishlistNote && (
                    <p className="mt-3 text-[12px] font-semibold" style={{ color: TEXT_MUTED }}>
                      Note: {summarizeCardCopy(primaryWishlistNote, 120)}
                    </p>
                  )}
...
function GiftTrackingWorkspace({
  ...
  assignments: RecipientData[];
  onUpdateGiftPrep: (groupId: string, status: GiftPrepStatus) => void;
  updatingPrepGroup: string | null;
}) {
  return (
    <section
      data-testid="gift-tracking-workspace"
        ...
        >
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            <div>
              ...
              <h2 className="mt-1 text-[20px] font-black text-slate-950">
                Gift for {assignment.receiver_nickname}
              </h2>
              <p className="mt-1 text-[12px] font-semibold" style={{ color: TEXT_MUTED }}>
                Current: {getGiftPrepLabel(assignment.gift_prep_status)}
              </p>
            </div>
            <span
              className="w-fit rounded-full px-3 py-1.5 text-[11px] font-extrabold"
              style={{
            ...
            >
              {assignment.gift_received ? "Recipient confirmed" : "Waiting for recipient"}
            </span>
          </div>
          ...
          <div className="mt-4 grid gap-2 sm:grid-cols-4">
            {GIFT_PREP_OPTIONS.map((option) => {
              ...
              const isDisabled =
                assignment.gift_received || updatingPrepGroup === assignment.group_id;

              return (
                <button
                  key={option.value}
                  type="button"
                  onClick={() => onUpdateGiftPrep(assignment.group_id, option.value)}
                  disabled={isDisabled}
                  className="min-h-11 rounded-2xl px-3 py-3 text-[11px] font-extrabold transition hover:-translate-y-0.5 disabled:hover:translate-y-0"
                  style={{
                    background: isActive
                      ? "linear-gradient(135deg,#48664e,#3c5a43)"
                      : "rgba(72,102,78,.07)",
                    border: `1px solid ${
                      isActive ? "rgba(72,102,78,.34)" : "rgba(72,102,78,.12)"
                    }`,
...
function getFriendlyLazadaLabel(value: string | null | undefined): string {
  ...
  if (normalized === "use your budget target" || normalized === "use your group budget") {
...
function getCuratedProductPriceLabel(
  ...
  if (!label || /^(budget target|group budget|target|typical spend):/i.test(label)) {
    return null;
  }
...
function SecretSantaExperience({ mode = "shopping" }: SecretSantaExperienceProps) {
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      ...
      try {
        ...
        const activeAssignments = ((myAssignments || []) as AssignmentRow[]).filter(
          (assignment) => activeGroupIds.has(assignment.group_id)
        );
        const activeReceivedAssignments = (
          (receivedAssignments || []) as ReceivedAssignmentRow[]
        ).filter((assignment) => activeGroupIds.has(assignment.group_id));
        let recipientData: RecipientData[] = [];
        const receivedGiftData = buildReceivedGiftData(
          activeReceivedAssignments,
          groupOptions
        );

        if (activeAssignments.length > 0) {
          const receiverIds = [
            ...new Set(activeAssignments.map((assignment) => assignment.receiver_id)),
          ];
          const activeGroupIdList = Array.from(activeGroupIds);
  ...
  const primaryActiveWishlistItemId = primaryAssignment
    ...
    : "";
  const primaryActiveWishlistItem =
    primaryAssignment?.receiver_wishlist.find(
      (wishlistItem) => wishlistItem.id === primaryActiveWishlistItemId
    ) ||
    primaryAssignment?.receiver_wishlist[0] ||
    null;
  const shoppingHelperActiveItemName =
    primaryActiveWishlistItem?.item_name ||
    (assignments.length > 1 ? "the selected wishlist item" : firstRecipientName);
  const shoppingHelperBudgetLabel =
    groupBudgetValue === "Set in group" ? null : groupBudgetValue;
  const modeHeroText: Record<
    SecretSantaExperienceMode,
    { title: string; description: string; cardLabel: string; cardValue: string; cardHelper: string }
  > = {
    shopping: {
  ...
  const sidebarNavItems: ShoppingIdeasNavItem[] = [
    ...
    { label: "My Wishlist", href: "/wishlist", icon: "wishlist" },
  ...
  return (
    ...
    >
      ...
      />
      <HolidayCornerSprig className="pointer-events-none fixed right-5 top-21.5 z-0 hidden h-24 w-24 opacity-80 2xl:block" />
      <style>{`
        ...
        @media (prefers-reduced-motion: reduce){.snowflake{animation:none!important;transition:none!important;}}
      `}</style>
      ...
      <div className={`relative z-10 min-h-screen ${sidebarCollapsed ? "xl:pl-20" : "xl:pl-70"}`}>
        ...
        >
          ...
          <div className="relative grid gap-4 lg:grid-cols-[minmax(0,1fr)_minmax(220px,280px)] lg:items-center">
            <div className="flex min-w-0 items-center gap-4">
              <span
                className="hidden h-16 w-16 shrink-0 items-center justify-center rounded-3xl sm:flex"
                style={{
        ...
        {mode === "giftee" && assignments.length > 0 && (
        ...
        {mode === "tracking" && assignments.length > 0 && (
          <GiftTrackingWorkspace
            ...
            onUpdateGiftPrep={handleUpdateGiftPrep}
            updatingPrepGroup={updatingPrepGroup}
          />
        )}

        {/* Shopping cards show assigned recipients, their wishlist items, and gift ideas only. */}
        {assignments.length === 0 ? (
          <div
                  ...
                  {assignment.receiver_wishlist.length === 0 ? (
                    ...
                    (() => {
                      ...
                      const heroLazadaCopy = summarizeCardCopy(
                          ...
                          item.item_note ||
                          `Start with ${item.item_name}, then open a shopping option that fits this recipient.`,
                        150
                      );
                      ...
                      return (
                        <div
                          className="grid min-w-0 gap-5 lg:grid-cols-[300px_minmax(0,1fr)] xl:grid-cols-1"
                              ...
                              return (
                                ...
                                >
                                  <div className="flex items-center gap-4">
                                    <div
                                      className="flex h-17 w-17 shrink-0 items-center justify-center overflow-hidden rounded-[10px] text-[19px] sm:h-18 sm:w-18"
                                      style={{
                            ...
                            <div className="min-w-0 space-y-4">
                              ...
                              <div className="grid min-w-0 gap-3">
                                <section
                                  ...
                                  className="relative hidden min-w-0 overflow-hidden rounded-3xl p-4 xl:block"
                                  style={{
                                    background: FRAMED_SURFACE_BACKGROUND,
                                    ...
                                    <div className="flex shrink-0 items-center gap-2">
                                      ...
                                      {assignment.receiver_wishlist.length >
                                        ...
                                        <button
                                          ...
                                          className="rounded-full px-3 py-1.5 text-[10px] font-extrabold transition hover:-translate-y-0.5 focus-visible:outline-2 focus-visible:outline-offset-2"
                                          style={{
                                            background: HOLIDAY_GREEN,
                                            color: "#fffdf7",
                                            outlineColor: HOLIDAY_GREEN,
                                    ...
                                    {visibleWishlistItems.map((wishlistItem) => {
                                      ...
                                      return (
                                        <button
                                          ...
                                          className="group min-w-0 rounded-[18px] p-2.5 text-left transition hover:-translate-y-0.5 focus-visible:outline-2 focus-visible:outline-offset-2"
                                          style={{
                                            background: isActiveItem
                                              ? "linear-gradient(135deg,#fffdf7 0%,rgba(255,238,238,.98) 100%)"
                                              : "rgba(255,255,255,.82)",
                                        ...
                                        >
                                          <div className="flex min-w-0 gap-3">
                                            <div
                                              className="flex h-14.5 w-14.5 shrink-0 items-center justify-center overflow-hidden rounded-[14px]"
                                              style={{
                                                background: "rgba(255,255,255,.9)",
                                                border:
                                ...
                                <section
                                  ...
                                  className="sticky top-0 z-20 min-w-0 overflow-hidden rounded-3xl p-3 sm:p-4 xl:top-24"
                                  style={{
                                    ...
                                    {suggestionOptions.map((suggestion) => {
                                      ...
                                      return (
                                        <button
                                          ...
                                          className="inline-flex min-h-13.5 w-full min-w-0 items-center justify-center gap-2 rounded-2xl border px-3 py-2.5 text-center transition hover:-translate-y-0.5 focus-visible:outline-2 focus-visible:outline-offset-2 sm:px-4 xl:px-5"
                                          style={{
                                          ...
                                          {isSelected && (
                                            <span
                                              ...
                                              style={{
                                                ...
                                                color: HOLIDAY_GREEN,
                                                boxShadow:
                                                  "0 8px 16px rgba(46,52,50,.12)",
                                              }}
                                            >
                                              <CheckCircleMark className="h-5 w-5" />
                                            </span>
                                          )}
                                          <div
                                ...
                                >
                                  <div
                                    ...
                                    className="group relative min-w-0 overflow-hidden rounded-3xl"
                                    style={{
                                  ...
                                  >
                                    ...
                                    <div
                                      className="relative flex min-h-27 min-w-0 items-center justify-center overflow-hidden p-2 text-[30px] sm:min-h-29 lg:min-h-31"
                                      style={{
                                ...
                                {selectedSuggestion && (
                                    <div className="min-w-0 space-y-4">
                                      ...
                                      {lazadaMatchedProductsState?.loading && (
                                        <div
                                          className="flex items-center gap-2 rounded-full px-3 py-1.5 text-[10px] font-semibold xl:hidden"
                                          style={{
                                      ...
                                      {curatedLazadaCards.length > 0 && (
                                        <section
                                          data-testid="curated-shopping-section"
                                          className="min-w-0 rounded-[28px] p-4 sm:p-5"
                                          style={{
                                            background:
                                              "linear-gradient(180deg,rgba(255,254,250,.985),rgba(249,251,247,.965))",
                                            border: SHOPPING_SHELL_BORDER,
                                            boxShadow: SHOPPING_SHELL_SHADOW,
                                          }}
                                        >
                                          <div className="mb-3 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                                            ...
                                            {heroLazadaHref && (
                                              <a
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="inline-flex w-fit items-center gap-1.5 rounded-full px-3 py-1.5 text-[11px] font-extrabold transition hover:-translate-y-0.5 focus-visible:outline-2 focus-visible:outline-offset-2"
                                                style={{
                                                  background: "rgba(255,255,255,.86)",
                                          ...
                                          >
                                            {curatedLazadaCards.map((product, index) => {
                                              ...
                                              const groupBudgetLabel =
                                                activeGroupBudgetLabel
                                                  ? `Group budget: ${activeGroupBudgetLabel}`
                                                  : null;
                                              ...
                                              return (
                                                ...
                                                >
                                                  ...
                                                  <div
                                                    ...
                                                    className="relative flex aspect-[1.85] min-w-0 items-center justify-center overflow-hidden p-4"
                                                    style={{
                                                      background:
                                                    ...
                                                    {productImageUrl ? (
                                                      ...
                                                      >
                                                        <div
                                                          ...
                                                          style={{
                                                            boxShadow: "inset 0 0 0 1px rgba(72,102,78,.08)",
                                                          }}
                                                        >
                                                          <ProductFallbackIllustration
                                                            title={product.title}
                                                          />
                                                        </div>
                                                        <div
                                                          className="absolute bottom-12 left-5 right-5 rounded-full px-3 py-1.5 text-center text-[11px] font-black uppercase tracking-[0.08em]"
                                                          style={{
                                                            background: "rgba(255,255,255,.74)",
                                                            color: PAGE_TEXT_COLOR,
                                                            boxShadow:
                                                              "0 12px 24px rgba(46,52,50,.08)",
                                                          }}
                                                        >
                                                          {fallbackVisualLabel}
                                                        </div>
                                                        <div
                                                          className="absolute bottom-5 rounded-full px-3 py-1 text-[9px] font-extrabold uppercase tracking-[0.12em]"
                                                          style={{
                                                            background:
                                                              "rgba(72,102,78,.1)",
                                                            color: HOLIDAY_GREEN,
                                                  ...
                                                  >
                                                    ...
                                                    <div
                                                      className="mt-2 flex-1 text-[12px] leading-relaxed xl:hidden"
                                                      style={{
                                                        color: TEXT_MUTED,
                                                        maxHeight: "3.1rem",
                                                        overflow: "hidden",
                                      ...
                                      {shoppingMerchantLinks.length > 0 && (
                                        <div
                                          ...
                                          style={{
                                            background:
                                              "linear-gradient(180deg,rgba(242,244,242,.74),rgba(255,254,250,.86))",
                                            border: "1px solid rgba(72,102,78,.14)",
                                            color: PAGE_TEXT_COLOR,
                                          }}
                                        >
                                          <div className="grid min-w-0 gap-4 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end">
                                            <div className="flex min-w-0 items-center gap-3">
                                              ...
                                              >
                                                <StorefrontMark className="h-4 w-4" />
                                              </span>
                                              <div className="min-w-0">
                                                <div
        ...
        {mode === "tracking" && receivedGifts.length > 0 && (
          <div className="mb-7">
